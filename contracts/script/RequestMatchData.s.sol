...
contract RequestMatchDataScript is Script {
    ...
    function run() external {
        ...
        string memory attestationType = toUtf8HexString("JsonApi");
        string memory sourceId = toUtf8HexString("WEB2");
        ...
        console.log(string(abi.encodePacked("ABI encoded request saved to data/", matchId, "_abiEncodedRequest.txt")));
        ...
        uint256 requestFee = fdcRequestFeeConfigurations.getRequestFee(response.abiEncodedRequest);
        ...
        // Request match data
        contestFactory.requestMatchData{value: requestFee}(contestId);
        ...
        console.log(string(abi.encodePacked("Voting round ID saved to data/", matchId, "_votingRoundId.txt")));
        console.log("Now waiting for the voting round to finalize (up to 3 minutes)...");
    }
}